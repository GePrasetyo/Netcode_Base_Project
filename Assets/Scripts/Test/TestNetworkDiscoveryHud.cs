...
namespace Test{
    [RequireComponent(typeof(TestNetworkDiscovery))]
    [RequireComponent(typeof(NetworkManager))]
    public class TestNetworkDiscoveryHud : MonoBehaviour
    {
        [SerializeField, HideInInspector]
        TestNetworkDiscovery m_Discovery;
        ...
        void Awake()
        {
            m_Discovery = GetComponent<TestNetworkDiscovery>();
